...
from check_site import PageParser, validate_case_index, validate_semantic_contracts  # noqa: E402
...
class SemanticContractTests(unittest.TestCase):
    ...
    def test_unknown_case_type_and_label_mismatch_are_reported(self) -> None:
        pages = {
            "sample.html": parse(
                '<article id="case-a" data-case-type="story"><p>历史案例</p></article>'
                '<article id="case-b" data-case-type="demo"><p>历史案例</p></article>'
            )
        }
        errors = validate_semantic_contracts(pages)
    ...
    def test_case_label_must_be_inside_the_case_container(self) -> None:
        pages = {
            "sample.html": parse(
                '<p>历史案例</p><article id="case-a" data-case-type="historical">无标签正文</article>'
            )
        }
        errors = validate_semantic_contracts(pages)
    ...
    def test_nested_same_tag_does_not_close_case_early(self) -> None:
        pages = {
            "sample.html": parse(
                '<section id="case-a" data-case-type="historical">'
    ...
    def test_unclosed_and_mismatched_case_containers_are_reported(self) -> None:
        unclosed = {"sample.html": parse('<article id="case-a" data-case-type="demo">演示场景')}
        mismatched = {
            "sample.html": parse('<section id="case-b" data-case-type="historical">历史案例</article>')
        }
        self.assertTrue(
    ...
    def test_case_index_requires_one_exact_page_anchor(self) -> None:
        pages = {
            "sample.html": parse(
                '<article id="case-a" data-case-type="historical">历史案例</article>'
            )
        }
    ...
    def test_case_index_rejects_type_mismatch_and_orphan(self) -> None:
        pages = {
            "sample.html": parse(
                '<article id="case-a" data-case-type="demo">演示场景</article>'
            )
        }
        index_text = (
