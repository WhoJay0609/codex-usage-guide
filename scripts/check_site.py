...
REQUIRED_TEXT = {
    ...
    "skills-repositories.html": ["Codex 相关高 stars 开源仓库", "Codex CLI 生态 Top 10", "taste-skill", "design-taste-frontend", "ian-xiaohei-illustrations", "awesome-chatgpt-prompts-zh", "prompts-zh.json", "不是原生 Codex skill", "认知锚点", "Codex Desktop", "Compound Engineering", "mattpocock/skills", "academic-research-skills-codex", "skills/academic-research-suite", "agentic-awesome-skills", "modelcontextprotocol/servers", "星标快照", "ARIS", "refine-user-prompt", "lidge-jun/opencodex", "第三方本地 provider proxy", "不是 Codex Skill、Plugin 或 MCP server", "127.0.0.1", "ocx restore", "不是 OpenAI 官方功能", "真实实例"],
