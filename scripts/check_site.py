...
REQUIRED_TEXT = {
    ...
    "git.html": [
        ...
        "把占位符替换成自己的值",
        "当前仓库根目录外的 sibling",
        "Local 指 Codex Desktop 当前前台打开的主工作区",
        "独立目录",
        "独立 index",
        "独立 HEAD",
        "共享 commits",
    ...
    "worktrees.html": ["Codex Desktop", "Hand off", "detached HEAD", ".worktreeinclude", "不是安全沙箱"],
...
SOURCE_REQUIRED_PAGES = {
    ...
    "git.html", "worktrees.html", "subagents.html", "goal.html", "automation.html",
...
REQUIRED_IMAGES = {
    "git.html": {
        "assets/worktree-guide/worktree-isolation.png",
        "assets/worktree-guide/worktree-delivery-loop.png",
    },
    "skills-repositories.html": {
